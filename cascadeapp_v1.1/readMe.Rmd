...
This web app generates HIV or/and HCV treatment and care cascade analysis using individual level data.
...
The user has the option to upload multiple datasets for HIV and for HCV. Each output will be generated for a complied dataset of all the uploaded datasets and separate tabs would show the results for each dataset separately.
