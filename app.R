          ...
          #First tab "intro" and connecting it to the readME file in the directory
            ...
            tabItem(tabName = "hiv",
                    ...
                    fluidRow(
                        ...
                        box(fluidRow(
                            ...
                            #using shinyjs to make the numeric input visible or not depending on the checkboxinput
                        ...
                        #multiple files are uploaded then mulptile tabs according to the number of files will be created in additional to
                        #the main one with the compiled data, otherwise it will only be one)
            ...
            tabItem(tabName = "hcv",
                    ...
                    fluidRow(
                        ...
                        #for the Cascade plot - retaintion in care as the outcome
                        uiOutput("tabshcvcascaderetained"),
                        #for the Cascade plot - re-infection as the outcome
...
server <- function(input, output){
  ...
  #to make the numeric input for the plhiv visible when plhiv is checked and invisible when it is unchecked
    ...
    #whether multiple files are uploaded or only 1
    ...
    #these objects will be used if plhiv is known
    ...
    #these objects will be used if plhiv is unknown
